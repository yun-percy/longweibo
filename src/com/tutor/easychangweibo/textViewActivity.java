...
//	 * @param height		图像显示的高度 Context mcontext
//	 */
...
////			BitmapDrawable bmpDraw=(BitmapDrawable)res.getDrawable(R.drawable.note_bg);
...
//			//设置画布背景颜色
////			canvas.drawBitmap(bmp,10,10,null);//ARGB(255,135,135,135);
